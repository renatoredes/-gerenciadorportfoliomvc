				...
				<div class="form-row">
					...
					<div class="col-md-2 mb-3">
					  ...
					  <select name="opcao" id="opcao" class="form-control">
						...
						<option value="opcao5">INICIADO</option>
						<option value="opcao6">PLANEJADO</option>
						<option value="opcao7">EM_ANDAMENTO</option>
						<option value="opcao8">ENCERRADO</option>
						<option value="opcao9">CANCELADO</option>
					  </select>
						</div>						
					</div>	
					<div class="col-md-2 mb-3">
